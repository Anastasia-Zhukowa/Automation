...
@pytest.mark.parametrize('num1, num2, result', [ (4,5,10) , (-6, -10, -16), (-6, 6, 0), (5.61, 4.29, 9.9), (10, 0, 10) ] )
def test_sum_positive_nums(num1, num2, result):
    calculator = Calculator()
    res = calculator.sum(num1, num2)
    assert res == result

# def test_sum_negative_nums(): # данный тест не нужен после указания массива данных и параметризации
#    calculator = Calculator()
#    res = calculator.sum(-6, -10)
#    assert res == -16

# def test_sum_positive_and_negative_nums(): # данный тест не нужен после указания массива данных и параметризации
#    calculator = Calculator()
