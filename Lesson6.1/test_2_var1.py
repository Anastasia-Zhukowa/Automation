...
def test_calculator(driver):
    ...
    #result = driver.find_element(By.CSS_SELECTOR, "div[class='screen']").get_attribute('textContent')
    #result = driver.find_element(By.CSS_SELECTOR, "div[class='screen']").get_attribute('class="screen"')
